...
// Converts a VMatrix to a table.
//
// @param tbl table (optional) The table to store the matrix in.
// @return table The table containing the matrix.
...
function playermeta:notUsingHands(wep)
	local activewep = wep or self:GetActiveWeapon()
